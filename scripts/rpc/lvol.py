...
def bdev_lvol_create_lvstore(client, bdev_name, lvs_name, cluster_sz=None, slice_sz=None, clear_method=None, write_factor=None):
    ...
    if write_factor:
        params['write_factor'] = write_factor
