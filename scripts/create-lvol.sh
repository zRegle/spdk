...
#else
device="/dev/nvme0n1"
$RPC bdev_nvme_attach_controller -b NVMe0 -t PCIe -a 0000:03:00.0
bdev="NVMe0n1"
#fi

echo "$device" > $SCRIPTS/base_dev

$RPC bdev_lvol_create_lvstore $bdev lvs0 -c $size -w 1.1 -s $2
...
# $RPC iscsi_target_node_add_lun iqn.2016-06.io.spdk:d0 lvs0/clone0
